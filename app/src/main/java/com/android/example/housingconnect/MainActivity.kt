...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        housingService = Retrofit.Builder()
            // Jenny, must be running repl server for this to work
            .baseUrl("https://Project-3-RentWell-Server-2.akosnikowski1.repl.co/") // Jenny, put your repl.it link here with a ' / ' after instead of mine
